...
public final class Kelvin implements Temperature {
     ...
     *
     * @return temperature in degrees with units of Kelvin
     */
    @Override
     ...
     * @return <code>Kelvin</code>, this object
     * @see io.github.motetpaper.temperature.Temperature#setValue(double)
     */
    @Override
    public final Kelvin setValue(double aValue) {
    ...
    public double toCelsius() {
        return this.value + Temperature.ZERO_K;
    }
